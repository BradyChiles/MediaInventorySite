            ...
            <div class="center">
               <div class="vert">
                <table style="margin-left:auto; margin-right:auto;">
                    ...
                    <tr>
                        <td colspan="2"><asp:Button ID="Button1" runat="server" class="btn btn-primary btn-space" Text="Login" OnClick="loginButton_Click" PostBackUrl="~/Main.aspx"/></td>
                    </tr>
                    <tr>
                        <td colspan="2">Not yet a member? Click <a href="RegistrationPage.aspx">HERE</a> to register!</td>
                    </tr>
                    <tr>
                        <td colspan="2">Want to change your password? Click <a href="RegistrationPage.aspx">HERE</a></td>
                    </tr>
                </table>
                   </div>
            </div>
